<div>
    <div class="order my-5">
        ...
        <div class="d-flex justify-content-around">
            ...
            <label for="{{ $item->name }}" class="card {{ $item->name }}" style="">
                <input onclick="activeClassCleaner('<?= $item->name ?>')" type='radio' required value='{{ $item->id }}' name='cleaner_id' id="{{ $item->name }}" />
                ...
                <div>
                    ...
                    <h3 class="text-center fs-20" style="color : #FFAA00;">
